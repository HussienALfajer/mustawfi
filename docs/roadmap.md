...
| A3 | Walking skeleton (`docs/product/modules/walking-skeleton.md`) | Closing — slice 15 (receipt on a real printer) moved to `sales`; slice 16 (ADR-0015 rule 5 check) done; the unit close remains |

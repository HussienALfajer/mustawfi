...
- Once merged, update local `main` and delete the local branch. If the PR is not merged when the session reports, **ينتظرك** carries the cleanup command instead (`AGENTS.md` → Reporting).

...
Sources: ADR-0023 (client application stack), ADR-0024 (visual design direction), ADR-0018 (money), `docs/design/design-system.md` once written.
...
- Screens use semantic tokens only (`--mf-*` through Tailwind `@theme`), never primitive colours. Text contrast is at least 4.5:1 at every size; control boundaries at least 3:1.
